...
import com.jimmy.commonlibrary.utils.NetworkUtils;
...
public class ListViewLoaingManager implements LoadingManager {
    ...
    public ListViewLoaingManager(Context mContext) {
        ...
        View containerView = LayoutInflater.from(mContext).inflate(R.layout.loading_manager_empty, null);
        emptyDataView = (LinearLayout) containerView
                .findViewById(R.id.loaing_emptydata_ll);
