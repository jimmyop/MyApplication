package com.jimmy.commonlibrary.base.adapter;
...
import com.jimmy.commonlibrary.imageloader.BaseImageLoader;
...
public class BaseArrayAdapter<T> extends BaseAdapter {
    ...
    public static class ViewHolder {
        ...
        public void loadImage(int id, String uri, Object options) {
            ImageView imageView = getView(id);
            BaseImageLoader.loadImage(imageView, uri, options);
        }
